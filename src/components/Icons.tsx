...
export const HashtagWithSpeechBubble: FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
...
export const Pin: FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export const Inbox: FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
...
export const Spyglass: FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
